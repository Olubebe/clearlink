            ...
            <div className="md:flex md:justify-between">
              <div className="mb-6 md:mb-0">
                <a href="https://flowbite.com" className="flex items-center">
                  <img src={Logo1} className="mr-3 h-8" alt="FlowBite Logo" />
                </a>
                <p className="text-md mt-10 text-gray-600 font-normal max-w-sm">
              ...
              <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-5">
                ...
                <div>
                  <h2 className="mb-6 text-md font-semibold text-blue-600 dark:text-white">
                    Get the app
                  </h2>
                  <ul className="text-gray-600 dark:text-gray-400">
                    <li className="mb-4">
